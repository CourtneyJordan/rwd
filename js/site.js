    ...
    $('#lightgallery-biking').on('click', function(){
    	...
    	$(this).lightGallery({
    		...
    		dynamicEl:[{
    			...
    			"src": 'rwd/images/biking/1.jpg',
	            'thumb': 'rwd/images/biking/1-thumb.jpg',
	            'subHtml': '<h4>Biking 1</h4><p>Wafer candy canes jujubes gingerbread.</p>'
	        }, {
	            'src': 'rwd/images/biking/2.jpg',
	            'thumb': 'rwd/images/biking/2-thumb.jpg',
	            'subHtml': '<h4>Biking 2</h4><p>Tootsie roll oat cake gingerbread cake.</p>'
	        }, {
	            'src': 'rwd/images/biking/3.jpg',
	            'thumb': 'rwd/images/biking/3-thumb.jpg',
	            'subHtml': '<h4>Biking 3</h4><p>Chupa chups croissant chocolate bar gummi bears biscuit.</p>'
	        }, {
	        	'src': 'rwd/images/biking/4.jpg',
	            'thumb': 'rwd/images/biking/4-thumb.jpg',
	            'subHtml': '<h4>Biking 4</h4><p>Dessert gingerbread jelly-o dessert lollipop marshmallow gummi bears.</p>'
	        }, {
	        	'src': 'rwd/images/biking/5.jpg',
	            'thumb': 'rwd/images/biking/5-thumb.jpg',
	            'subHtml': '<h4>Biking 5</h4><p>Halvah biscuit jelly-o cookie dessert.</p>'
	        }, {
	        	'src': 'rwd/images/biking/6.jpg',
	            'thumb': 'rwd/images/biking/6-thumb.jpg',
	...
	$('#lightgallery-fishing').on('click', function(){
    	...
    	$(this).lightGallery({
    		...
    		dynamicEl:[{
    			...
    			"src": 'rwd/images/fishing/1.jpg',
	            'thumb': 'rwd/images/fishing/1-thumb.jpg',
	            'subHtml': '<h4>Fishing 1</h4><p>Brownie biscuit candy canes oat cake pie souffle liquorice.</p>'
	        }, {
	            'src': 'rwd/images/fishing/2.jpg',
	            'thumb': 'rwd/images/fishing/2-thumb.jpg',
	            'subHtml': '<h4>Fishing 2</h4><p>Muffin jelly-o souffle sesame snaps topping chocolate bar toffee.</p>'
	        }, {
	            'src': 'rwd/images/fishing/3.jpg',
	            'thumb': 'rwd/images/fishing/3-thumb.jpg',
	            'subHtml': '<h4>Fishing 3</h4><p>Dessert sweet roll bonbon carrot cake ice cream danish.</p>'
	        }, {
	        	'src': 'rwd/images/fishing/4.jpg',
	            'thumb': 'rwd/images/fishing/4-thumb.jpg',
	            'subHtml': '<h4>Fishing 4</h4><p>Wafer candy canes jujubes gingerbread.</p>'
	        }, {
	        	'src': 'rwd/images/fishing/5.jpg',
	            'thumb': 'rwd/images/fishing/5-thumb.jpg',
	            'subHtml': '<h4>Fishing 5</h4><p>Pudding danish candy apple pie.</p>'
	        }, {
	        	'src': 'rwd/images/fishing/6.jpg',
	            'thumb': 'rwd/images/fishing/6-thumb.jpg',
...
$('#lightgallery-hiking').on('click', function(){
    	...
    	$(this).lightGallery({
    		...
    		dynamicEl:[{
    			...
    			"src": 'rwd/images/hiking/1.jpg',
	            'thumb': 'rwd/images/hiking/1-thumb.jpg',
	            'subHtml': '<h4>Hiking 1</h4><p>Chupa chups croissant chocolate bar gummi bears biscuit.</p>'
	        }, {
	            'src': 'rwd/images/hiking/2.jpg',
	            'thumb': 'rwd/images/hiking/2-thumb.jpg',
	            'subHtml': '<h4>Hiking 2</h4><p>Chocolate bar danish candy canes sugar plum.</p>'
	        }, {
	            'src': 'rwd/images/hiking/3.jpg',
	            'thumb': 'rwd/images/hiking/3-thumb.jpg',
	            'subHtml': '<h4>Hiking 3</h4><p>Tiramisu macaroon dessert.</p>'
	        }, {
	        	'src': 'rwd/images/hiking/4.jpg',
	            'thumb': 'rwd/images/hiking/4-thumb.jpg',
	            'subHtml': '<h4>Hiking 4</h4><p>Cake dragée sweet cupcake lemon drops.</p>'
	        }, {
	        	'src': 'rwd/images/hiking/5.jpg',
	            'thumb': 'rwd/images/hiking/5-thumb.jpg',
	            'subHtml': '<h4>Hiking 5</h4><p>Jelly sweet roll topping chocolate croissant croissant candy canes.</p>'
	        }, {
	        	'src': 'rwd/images/hiking/6.jpg',
	            'thumb': 'rwd/images/hiking/6-thumb.jpg',
	...
	$('#lightgallery-wildlife').on('click', function(){
    	...
    	$(this).lightGallery({
    		...
    		dynamicEl:[{
    			...
    			"src": 'rwd/images/wildlife/1.jpg',
	            'thumb': 'rwd/images/wildlife/1-thumb.jpg',
	            ...
	            'src': 'rwd/images/wildlife/2.jpg',
	            'thumb': 'rwd/images/wildlife/2-thumb.jpg',
	            'subHtml': '<h4>Wildlife 2</h4><p>Halvah cookie marzipan sugar plum chocolate bar.</p>'
	        }, {
	            'src': 'rwd/images/wildlife/3.jpg',
	            'thumb': 'rwd/images/wildlife/3-thumb.jpg',
	            'subHtml': '<h4>Wildlife 3</h4><p>Pudding cake dessert tootsie roll cheesecake pie cake.</p>'
	        }, {
	        	'src': 'rwd/images/wildlife/4.jpg',
	            'thumb': 'rwd/images/wildlife/4-thumb.jpg',
	            'subHtml': '<h4>Wildlife 4</h4><p>Icing cotton candy donut marzipan cotton candy muffin.</p>'
	        }, {
	        	'src': 'rwd/images/wildlife/5.jpg',
	            'thumb': 'rwd/images/wildlife/5-thumb.jpg',
	            'subHtml': '<h4>Wildlife 5</h4><p> Cookie pie pastry danish lollipop wafer.</p>'
	        }, {
	        	'src': 'rwd/images/wildlife/6.jpg',
	            'thumb': 'rwd/images/wildlife/6-thumb.jpg',
